            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
             ...
             //   Sos sosValue = dataSnapshot.getValue(Sos.class);
                ...
                if (value != null) {
                    ...
                    nav_userEmail.setText(bio);
                    Glide.with(getApplicationContext()).load(value.getImageUrl()).placeholder(R.drawable.blank) // Place holder image
                            .error(R.drawable.blank).into(nav_userImage);
                }
