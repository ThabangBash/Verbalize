        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (value != null) {
                    ...
                    Glide.with(getApplicationContext()).load(sDownloadUri).into(imProfilePic);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.updatSos) {
          ...
          Person person = new Person();
            ...
            person.setBio(textViewBio.getText().toString());
            person.setCellphone(textViewCellphone.getText().toString());
            person.setImageUrl(sDownloadUri);
