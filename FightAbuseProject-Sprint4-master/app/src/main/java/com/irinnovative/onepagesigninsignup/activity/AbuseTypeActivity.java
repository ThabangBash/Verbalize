...
/*
    ...
    public void populate() {
        ...
        listAbuse.add(new Abuse("Sexual Abuse", "Any behaviors that impact a person’s ability to control their " +
                "sexual activity or the circumstances in which sexual\n" +
                "activity occurs,Most victims and perpetrators know\n" +
                "each other. Immediate reactions to sexual abuse include shock, fear or disbelief. Long-term symptoms include anxiety, fear or post-traumatic stress disorder,while efforts to treat sex offenders remain unpromising, psychological interventions for survivors — especially group therapy — appears effective." +"\n" + "\n\n" + "Effects of Sexual Abuse " + "\n\n"  +"What are common mental effects of sexual assault and rape?\n" +
